...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-title>Request</ion-title>\n    <ion-buttons slot=\"primary\">\n      <ion-button (click)=\"dismiss()\">\n        <ion-icon slot=\"icon-only\" name=\"close\"></ion-icon>\n      </ion-button>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n<ion-content class=\"ion-padding\">\n  <form [formGroup]=\"requestWorker\" (ngSubmit)=\"logForm('worker')\" *ngIf = \"requestWorker.value.workerName\">\n    <ion-list>\n      <ion-item>\n        <ion-label>Worker Name</ion-label>\n        <ion-input type=\"text\" formControlName=\"workerName\" disabled></ion-input>\n      </ion-item>\n      <ion-item>\n        <ion-label>Category</ion-label>\n        <ion-input type=\"text\" formControlName=\"category\" disabled></ion-input>\n      </ion-item>\n      <ion-item>\n        <ion-label>Gender</ion-label>\n        <ion-input type=\"text\" formControlName=\"gender\" disabled></ion-input>\n      </ion-item>\n      <ion-item>\n        <ion-label>City</ion-label>\n        <ion-input type=\"text\" formControlName=\"city\" disabled></ion-input>\n      </ion-item>\n      <ion-item>\n        <ion-label>Message</ion-label>\n        <ion-input type=\"text\" formControlName=\"message\"></ion-input>\n      </ion-item>\n    </ion-list>\n    <ion-row>\n      <ion-col offset=\"4\">\n        <ion-button type=\"submit\">Submit</ion-button>\n      </ion-col>\n    </ion-row>\n  </form>\n  <form [formGroup]=\"requestSeeker\" (ngSubmit)=\"logForm('seeker')\" *ngIf = \"requestSeeker.value.seekerName\">\n    <ion-list>\n      <ion-item>\n        <ion-label>Seeker Name</ion-label>\n        <ion-input type=\"text\" formControlName=\"seekerName\" disabled></ion-input>\n      </ion-item>\n      <ion-item>\n        <ion-label>Category</ion-label>\n        <ion-input type=\"text\" formControlName=\"category\" disabled></ion-input>\n      </ion-item>\n      <ion-item>\n        <ion-label>Gender</ion-label>\n        <ion-input type=\"text\" formControlName=\"gender\" disabled></ion-input>\n      </ion-item>\n      <ion-item>\n        <ion-label>City</ion-label>\n        <ion-input type=\"text\" formControlName=\"city\" disabled></ion-input>\n      </ion-item>\n      <ion-item>\n        <ion-label>Message</ion-label>\n        <ion-input type=\"text\" formControlName=\"message\"></ion-input>\n      </ion-item>\n    </ion-list>\n    <ion-row>\n      <ion-col offset=\"4\">\n        <ion-button type=\"submit\">Submit</ion-button>\n      </ion-col>\n    </ion-row>\n  </form>\n</ion-content>\n"
...
var ModalPage = /** @class */ (function () {
    function ModalPage(modalController, navParams, formBuilder) {
        this.modalController = modalController;
        this.navParams = navParams;
        this.formBuilder = formBuilder;
        this.requestWorker = this.formBuilder.group({
            workerName: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
        ...
        this.requestSeeker = this.formBuilder.group({
            seekerName: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            city: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            category: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            gender: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            message: [''],
    ...
    ModalPage.prototype.logForm = function (type) {
        if (type === 'worker') {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _modal_modal_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../modal/modal.page */ "./src/app/modal/modal.page.ts");
...
var SharedModule = /** @class */ (function () {
    ...
    SharedModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                _modal_modal_page__WEBPACK_IMPORTED_MODULE_2__["ModalPage"]
            ],
            imports: [
